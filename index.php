...
<body>
    ...
    <div class="sign-container">
        <div class="sign-in-pop-up" id="signInPopUp">
            ...
            <div class="sign-in-text">
                Kindly provide your credentials to access the secure portal. To proceed, please enter the following information
            </div>
            <div class="sign-in-inputs">
                <form action="">
                    <label class="label-field-sign-in" for="fullname">Username:</label><br>
                    <input class="sign-in-input" type="text" name="username" required><br><br>
            
                    <label class="label-field-sign-in" for="password">Password:</label><br>
                    <input class="sign-in-input" type="password" name="password" required>
    ...
    <nav class="navbar">
        ...
        <div class="nav-sections">
            <ul>
                ...
                <li class="nav-item"><a href="#sign-in" class="btn-sign-in nav-link" id="signInLink">SIGN IN</a></li>
            </ul>
        </div>
        <div class="hamburger">
            <span class="bar"></span>
    ...
    <main id="home">
        <div class="bg-front">
            ...
            <div class="container-center">
                ...
                <button class="appointment-btn">Appoint Now</button>
            </div>
        </div>
    </main>
    ...
    <section id="services">
        <div class="services">
            ...
            <div class="line"></div>
            <div class="texts">
                <div class="text-1">Clinic services encompass a wide range of specialized medical care offerings, addressing diverse healthcare needs. From cardiology to pediatrics, these clinics play a crucial role in providing tailored healthcare solutions to individuals and communities.</div>
                <div class="text-2">In this brief introduction, we will explore the significance of various clinic services in meeting the specific needs of patients.</div>
                <div class="text-3">Explore our Services</div>
            </div>
            <div class="grid-container-services">
                <div class="grid-item color-1"><img class="services-img1" src="Assets/images/service2.png" alt="Services">
                    <div class="service-title">
                        Speciality Consultations
                    </div>
                </div>
                <div class="grid-item color-2"><img class="services-img2" src="Assets/images/service6.png" alt="Services">
                    <div class="service-title">
                        Nephrology
                    </div>
                </div>
                <div class="grid-item color-3"><img class="services-img3" src="Assets/images/service4.png" alt="Services">
                    <div class="service-title">
                        Pulmonology
                    </div>
                </div>
                <div class="grid-item color-4"><img class="services-img4" src="Assets/images/service1.png" alt="Services">
                    <div class="service-title">
                        Urology
                    </div>
                </div>
                <div class="grid-item color-5"><img class="services-img5" src="Assets/images/service5.png" alt="Services">
                    <div class="service-title">
                        Orthopedics
                    </div>
                </div>
                <div class="grid-item color-6"><img class="services-img6" src="Assets/images/service3.png" alt="Services">
                    <div class="service-title">
                        Endocrinology
                    </div>
                </div>          
    ...
    <section id="doctors">
        <div class="doctors">
            ...
            <div class="line"></div>
            <div class="text-doctors">"𝑷𝒓𝒊𝒐𝒓𝒊𝒕𝒊𝒛𝒆 𝒀𝒐𝒖𝒓 𝑾𝒆𝒍𝒍-𝒃𝒆𝒊𝒏𝒈 𝑻𝒐𝒅𝒂𝒚 𝒇𝒐𝒓 𝒂 𝑯𝒆𝒂𝒍𝒕𝒉𝒊𝒆𝒓 𝑻𝒐𝒎𝒐𝒓𝒓𝒐𝒘! 𝑬𝒙𝒑𝒍𝒐𝒓𝒆 𝒐𝒖𝒓 𝒄𝒐𝒎𝒑𝒓𝒆𝒉𝒆𝒏𝒔𝒊𝒗𝒆 𝒉𝒆𝒂𝒍𝒕𝒉 𝒔𝒆𝒓𝒗𝒊𝒄𝒆𝒔 𝒂𝒏𝒅 𝒔𝒕𝒂𝒓𝒕 𝒚𝒐𝒖𝒓 𝒘𝒆𝒍𝒍𝒏𝒆𝒔𝒔 𝒋𝒐𝒖𝒓𝒏𝒆𝒚 𝒘𝒊𝒕𝒉 𝒖𝒔 𝒂𝒕 <span class="ft-bold"><br><br>CMM Medical and Diagnostic Clinic.</span>"</div>
        </div>
        <div class="grid-container-doctors">
            <div class="grid-item color-green">
                ...
                <div class="doctors-info-green back-card">
                    ...
                    <div class="doctors-text-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</div>
    ...
    <section id="about-us">
        <div class="about-us-top">
            ...
            <div class="texts">
                ...
                <div class="text-about-us">Caring for life, researching for health, educating those who serve</div>
                <h2 class="text-title-about-us">Vision</h2>
                <div class="text-about-us">Our vision for the CMM is to be the best place for care anywhere and the best place to work in healthcare.</div><br>
            </div>
        </div>
        <div class="about-us">
            <div class="map-left">
                <iframe class="map-frame" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3860.057293357939!2d120.96968207578999!3d14.652689175797883!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397b5d8a76b7da5%3A0xe80243276b5d5fdc!2sCMM%20Medical%20and%20Diagnostic%20Clinic!5e0!3m2!1sen!2sph!4v1693922635928!5m2!1sen!2sph" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
        <div class="about-us-bottom">
            ...
            <div class="email">
                ...
                <a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJvlqhcsKZzBbrnFCNGdmkWwFsZzDjlRtQSMZLHrqXppcLcvlhQqxFhRqBLmPnJFVhMnCHg">clinicname@gmail.com</a>
            </div>
            <div class="facebook">
                <i class='bx bxl-facebook-circle bx-sm icon-about-us' ></i>
                <a href="https://www.facebook.com/cmm.mdc/photos">https://www.facebook.com/cmm.mdc/photos</a>
            </div>
        </div>
    </section>
    ...
    <footer id="footer">
        <div class="footer">
            <div class="top-footer">
                <div class="icon-head"><img class="footer-icon-img" src="Assets/images/footer-icon.png" alt="Footer Icon"></div>
            ...
            <div ><a href="#footer" class="copyrights">2023 Copyright. All rights reserved.</a></div>
        </div>
    </footer>
