                        ...
                        <div class="settings-container">
                            ...
                            <div class="settings-right">
                                ...
                                <form action="../backend/updateDoctorsProfile.php?docno=<?php echo $docID; ?>" method="POST">
                                    ...
                                    ?>
                                        <label for="field">Nurse Field</label>
                                        <select name="field">
                                            <option value="" disabled <?php if ($fetch_recurd['doctorField'] == '') echo 'selected'; ?>>Select</option>
                                            <option value="Registered Nurse" <?php if ($fetch_recurd['doctorField'] == 'Registered Nurse') echo 'selected'; ?>>Registered Nurse</option>
                                            <option value="Nurse Anesthetist" <?php if ($fetch_recurd['doctorField'] == 'Nurse Anesthetist') echo 'selected'; ?>>Nurse Anesthetist</option>
                                            <option value="Nurse Practitioner" <?php if ($fetch_recurd['doctorField'] == 'Nurse Practitioner') echo 'selected'; ?>>Nurse Practitioner</option>
                                        </select>
                                    </div>
                                    <div class="pw-container">
