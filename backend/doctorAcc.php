...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $doctor_password = password_hash($_POST["pword"], PASSWORD_DEFAULT); // Corrected variable name
    ...
    if (empty($doctor_firstname) || empty($doctor_lastname) || empty($doctor_username) || empty($doctor_password) || empty($doctor_email) || $doctor_occupation == "null") {
        ...
        $stmt->bind_param("ssssss", $doctor_firstname, $doctor_lastname, $doctor_username, $doctor_password, $doctor_email, $doctor_occupation); // Corrected variable name
